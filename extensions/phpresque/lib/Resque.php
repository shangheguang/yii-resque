...
class Resque
{
	...
	public static function redis()
	{
		...
		if (is_callable(self::$redisServer)) {
			self::$redis = call_user_func(self::$redisServer, self::$redisDatabase, self::$password);
		} else {
			self::$redis = new Resque_Redis(self::$redisServer, self::$redisDatabase, self::$password);
		}
